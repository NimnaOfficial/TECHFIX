...
txt = re.sub(
    r'await env.DB.prepare\(\s*INSERT INTO notifications \(id, user_id, appointment_id, title, message, notification_type, is_read\) VALUES \(\?, \?, \?, \'Payment Received\',\s*\'Payment confirmed\.\', \'PAYMENT\', 0\)\s*\)\.bind',
