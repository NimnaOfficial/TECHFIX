...
public interface TechFixDao {
    ...
    void insertPart(
            SparePartEntity part
    );

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    void insertParts(
            List<SparePartEntity> parts
    );
    ...
    RepairHistoryEntity getHistoryItem(
            String repairId
    );

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    void insertHistory(
            RepairHistoryEntity history
    );

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    void insertHistoryList(
            List<RepairHistoryEntity> historyList
    );
    ...
    List<PaymentEntity> getPaymentsByStatus(
            String status
    );
    ...
    @Query(
            "SELECT * FROM local_appointments " +
    ...
    AppointmentEntity getAppointmentById(
    ...
    List<AppointmentEntity> getAppointmentsByCustomer(
            String customerId
    );
    ...
    List<AppointmentEntity> getAppointmentsByTechnician(
            String technicianId
    );
    ...
    List<AppointmentEntity> getAppointmentsByStatus(
            String status
    );
    ...
    void clearAppointmentsForCustomer(
            String customerId
    );
    ...
    void clearAppointmentsForTechnician(
            String technicianId
    );
